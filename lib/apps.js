...
export const APPS = [
  {
    ...
    commands: [
      { name: "taeglich", signature: "/taeglich", desc: "Hole deine taegliche Belohnung ab." },
      ...
      { name: "kampf", signature: "/kampf", desc: "Kaempfe im 1v1 gegen Spieler oder Bot." },
      { name: "sammlung", signature: "/sammlung", desc: "Zeige deine Karten-Sammlung." },
      { name: "verbessern", signature: "/verbessern", desc: "Verstaerke deine Karten mit Infinitydust." },
      { name: "anfang", signature: "/anfang", desc: "Startmenue mit Schnellzugriff." }
    ],
    cardsPreview: [
      "Black Widow",
      "Iron-Man",
